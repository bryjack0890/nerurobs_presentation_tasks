scenario = "First-order Control trial"; #Name, used for references 
...
array {
   ...
   $k = '$i + 1';
   bitmap { filename = "1stCInstructionCues\\InstructionCue$k.png"; description = "$k"; } "ic$k"; 
   ENDLOOP;
...
string filename = logfile.subject() + "1stC PrintOut";
